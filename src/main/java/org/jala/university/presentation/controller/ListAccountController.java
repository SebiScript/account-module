...
public final class ListAccountController
    ...
    private final ObservableList<AccountDto> accounts =
    ...
    public void onUpdate() {
        AccountDto account = accountsTable
                .getSelectionModel()
                .getSelectedItem();
        if (account == null) {
        ...
        UpdateViewContext updateViewContext = UpdateViewContext
                ...
                .build();
        ViewSwitcher.switchTo(AccountView.UPDATE.getView(), updateViewContext);
    }
